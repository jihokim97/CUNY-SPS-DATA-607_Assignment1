...
Super bowl advertisements are considered to be the most popular commercials in the United States where companies present creative advertisements to draw viewer's attentions. The dataset from 233 commercials were categorized into 7 differenct characteristics and the goal is to create a barlpot to visualize the frequencies of each category. The article can be found on https://projects.fivethirtyeight.com/super-bowl-ads/
...
creating barplot to see which was the mose used 

```{r bar plots}
numcounts <- c(168,166,41,68,75,89,63)
brplt <- barplot(numcounts, main ='frequencies of the theme in commercials', xlab='theme', ylab='numberofcounts', names.arg = c('funny','quickly','patriot','celebrity','danger','animals','usesex'),horiz = F)
```
